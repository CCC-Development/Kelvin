...
public class RenderItemEvent extends Event
{
    ...
    public RenderItemEvent(ItemStack heldItem, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource source, int light, int overlay, float deltaTicks)
    {
    ...
    public static class Held extends RenderItemEvent
    {
        ...
        public Held(LivingEntity entity, ItemStack heldItem, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource source, HumanoidArm arm, int light, int overlay, float deltaTicks)
        {
            super(heldItem, displayContext, poseStack, source, light, overlay, deltaTicks);
            this.entity = entity;
            this.arm = arm;
        }
        ...
        {
            public Pre(LivingEntity entity, ItemStack heldItem, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource source, HumanoidArm HumanoidArm, int light, int overlay, float deltaTicks)
            {
                super(entity, heldItem, displayContext, poseStack, source, HumanoidArm, light, overlay, deltaTicks);
            }
        }
        ...
        {
            public Post(LivingEntity entity, ItemStack heldItem, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource source, HumanoidArm HumanoidArm, int light, int overlay, float deltaTicks)
            {
                super(entity, heldItem, displayContext, poseStack, source, HumanoidArm, light, overlay, deltaTicks);
            }
