...
public class DoorButton extends IconButton
{
    ...
    public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks)
    {
        ...
        graphics.fill(this.getX() + 3, this.getY() + this.height - 6, this.getX() + this.width - 3, this.getY() + this.height - 3, backgroundColor);
        graphics.fill(this.getX() + 3, this.getY() + this.height - 6, this.getX() + this.width - 4, this.getY() + this.height - 4, foregroundColor);
    }
