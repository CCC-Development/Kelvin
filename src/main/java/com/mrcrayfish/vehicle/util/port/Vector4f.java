...
public class Vector4f extends org.joml.Vector4f {
    ...
    public org.joml.Vector4f set(float p_195911_1_, float p_195911_2_, float p_195911_3_, float p_195911_4_) {
        this.x = p_195911_1_;
        this.y = p_195911_2_;
        this.z = p_195911_3_;
        this.w = p_195911_4_;
    ...
    public org.joml.Vector4f normalize() {
    ...
    // Forge start
    public org.joml.Vector4f set(float[] values) {
        this.x = values[0];
        this.y = values[1];
        this.z = values[2];
        this.w = values[3];
